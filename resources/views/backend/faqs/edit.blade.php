...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">FAQ Edit</h4>
            ...
            <div class="col-12 mx-auto">
                <div class="card">
                    <div class="card-body order-list">
                        ...
                        {{ Form::model($editModeData,['route' =>['admin.faqs.update',$editModeData->id ],'method' => 'PUT','files'=>'true','id'=>'faqs-form'])}}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('question', $editModeData->question, ['class' => 'form-control', 'required' => 'required'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('answer', $editModeData->answer, ['class' => 'form-control', 'required' => 'required'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::number('priority', $editModeData->priority, ['class' => 'form-control', 'required' => 'required'])}}
