...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Slide Create</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.slides.index') }}">Slides</a></li>
                    <li class="breadcrumb-item active">Slide Create</li>
                </ol>
            </div>
            ...
            <div class="col-8 mx-auto">
                <div class="card">
                    <div class="card-body order-list">
                        ...
                        {{ Form::open(['route' => 'admin.slides.store','id'=>'slides-form','files'=>'true']) }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('slide_title', '', ['class' => 'form-control', 'required' => 'required'])}}
                            ...
                            <div class="col-md-12">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="file" id="slide" class="form-control mb-3" name="slide" accept="image/*" required />
                                        @if($errors->has('slide'))
