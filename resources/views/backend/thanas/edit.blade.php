            ...
            <div class="col-12 mx-auto">
                <div class="card">
                    <div class="card-body order-list">
                        ...
                        {{ Form::model($editModeData,['route' =>['admin.thanas.update',$editModeData->id ],'method' => 'PUT','files'=>'true','id'=>'thanas-form'])}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('thana_en', $editModeData->thana_en, ['class' => 'form-control', 'required' => 'required'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {{Form::text('thana_bn', $editModeData->thana_bn, ['class' => 'form-control'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::text('start_date', $editModeData->start_date, ['id' =>'start_date','class' => 'form-control datepicker', 'placeholder' => 'Start Date', 'required' => 'required', 'autocomplete'=>'off']) !!}
                            ...
                            <div class="col-md-6">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::text('end_date', $editModeData->end_date, ['id' =>'end_date','class' => 'form-control datepicker', 'placeholder' => 'End Date', 'required' => 'required', 'autocomplete'=>'off']) !!}
