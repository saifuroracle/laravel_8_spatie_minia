...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Event Schedule Create</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.event.schedules.index') }}">Event Schedule</a></li>
                    <li class="breadcrumb-item active">Event Schedule Create</li>
                </ol>
            </div>
            ...
            <div class="col-8 mx-auto">
                <div class="card">
                    <div class="card-body order-list">
                        ...
                        {{ Form::open(['route' => 'admin.event.schedules.store','id'=>'noticeboard-form']) }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::text('schedule_date', '', ['id' =>'schedule_date','class' => 'form-control datepicker', 'placeholder' => 'Schedule Date', 'required' => 'required', 'autocomplete'=>'off']) !!}
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('division_id', ['' => 'Select Division']+ $parentdivisions, null, ['id'=>'division_id','class' => 'form-control', 'required'=>'true']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('district_id', ['' => 'Select District'], null, ['id'=>'district_id','class' => 'form-control', 'required'=>'true']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('thanas[]', ['' => 'Select Thanas'], [], ['id' =>'thanas','class' => 'form-control select2 multiple', 'required' => 'required','multiple']) !!}
            ...
            if(division_id) {
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        $('select[name="district_id"]').append('<option value="" style="display: none">Select District</option>');
                        $('select[name="thanas[]"]').append('<option value="" style="display: none">Select Tahans</option>');
